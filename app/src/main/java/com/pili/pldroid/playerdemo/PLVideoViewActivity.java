...
public class PLVideoViewActivity extends VideoPlayerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置 MP4 DRM 密钥
        options.setString(AVOptions.KEY_COMP_DRM_KEY, "lanyoga");
        ...
        mMediaController = findViewById(R.id.mediaController);
        mMediaController.setOnClickSpeedAdjustListener(mOnClickSpeedAdjustListener);
        mVideoView.setMediaController(mMediaController);
        mMediaController.setInteractionListener(new MediaController.InteractionListener() {
            @Override
            public void onZoom() {
                onClickSwitchScreen();
            }
